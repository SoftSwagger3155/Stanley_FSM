...
namespace Stanley_MCPNet.Motion
{
    public class MtrMotionProfileManager
    {
        ...
        public bool Load()
        {
            ...
            {
                bool flag = false;
                List<AxisMotionProfile> list = (List<AxisMotionProfile>)XmlHelper.LoadXml(typeof(List<AxisMotionProfile>), text);
        ...
        public void Save(List<AxisMotionProfile> profiles)
        {
            ...
            XmlHelper.SaveXml(typeof(List<AxisMotionProfile>), this.allAxisProfile, fileName);
        }
