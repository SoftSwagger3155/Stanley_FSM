    ...
    public class MtrMotionProfileManager
    {
        ...
        public bool Load()
        {
            ...
            else
            {
                ...
                List<AxisMotionProfile> list = (List<AxisMotionProfile>)XmlHelper.DeserializeXElement(targetObj, typeof(List<AxisMotionProfile>));
        ...
        public void Save(List<AxisMotionProfile> profiles)
        {
            string fileName = Path.Combine(this.systemDir, this.ProfileFileName + ".xml");
            XmlHelper.SerializeFile<AxisMotionProfile>(fileName, profiles);
